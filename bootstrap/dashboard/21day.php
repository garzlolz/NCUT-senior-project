...
<?php
    $perpage = 7;
    $sql = "SELECT * FROM `arduino_db`.`temperature`  WHERE `t_time` LIKE '%12:00:0%' ORDER BY `t_time` DESC LIMIT 14,21";
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="http://172.20.10.7/arduino2/bootstrap/dashboard/7day.php">三個禮拜前</a>
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">三個禮拜前 <input type="button" id= "btnprint" value="列印本頁" onclick=Print()></h1>
        ...
        <form action="export/export21.php">
