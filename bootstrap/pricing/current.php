...
<header class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  ...
  <nav class="my-2 my-md-0 me-md-3">
    ...
    <a class="p-2 text-dark" href="../carousel/about.html">這些數字是什麼?</a>
  </nav>
...
<main class="container">
  ...
  <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
    ...
    <div class="col">
      <div class="card mb-4 shadow-sm">
      <div class="card-header">
        <h4 class="my-0 fw-normal">空氣粉塵</h4>
      </div>
      <div class="card-body">
  ...
  <footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row">
      <div class="col-12 col-md">
        <img class="mb-2" src="https://img.icons8.com/ios/452/g.png" alt="" width="24" height="22">
        <img class="mb-2" src="https://img.icons8.com/ios/452/a.png" alt="" width="24" height="22">
        <img class="mb-2" src="https://img.icons8.com/ios/452/r.png" alt="" width="24" height="22">
        <img class="mb-2" src="https://img.icons8.com/ios/452/z.png" alt="" width="24" height="22">
        <small class="d-block mb-3 text-muted">&copy; GarZ</small>
      </div>
      <div class="col-6 col-md">
        <h5>關於作者</h5>
        <ul class="list-unstyled text-small">
          <li><a class="link-secondary" href="https://www.facebook.com/profile.php?id=100006845141688">Facebook</a></li>
          <li><a class="link-secondary" href="https://www.instagram.com/garz.1333/">instagram</a></li>
        </ul>
      </div>
    </div>
  </footer>
